...
public:
  Well(const std::string filename)
    : m_wellname(""), m_wellno(""), m_dateOfRecentTest(""), m_dailyOil(""), m_dailyWater(""),
      m_dailyGas(""), m_opPressureTubing(""), m_opPressureCasing(""), m_pumpingUnitSize(""),
      m_strokesPerMin(""), m_strokeLength(""), m_motorHp(""), m_pumpingRatio(""), m_unitGearRatio(""),
      m_casingSize(""), m_tubingSize(""), m_pumpSize(""), m_firstCole(""), m_secondCole(""),
      m_thirdCole(""), m_comments(""), m_filename(filename) {
    std::ifstream myfile;
...
private:
  std::string m_wellname, m_wellno, m_dateOfRecentTest, m_dailyOil, m_dailyWater, m_dailyGas, m_opPressureTubing,
      m_opPressureCasing, m_pumpingUnitSize, m_strokesPerMin, m_strokeLength, m_motorHp, m_pumpingRatio,
